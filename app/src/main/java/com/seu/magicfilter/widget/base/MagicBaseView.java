...
public abstract class MagicBaseView extends GLSurfaceView implements GLSurfaceView.Renderer{
    /**
     * 所选择的滤镜，类型为 MagicBaseGroupFilter
    ...
    public void setFilter(final MagicFilterType type){//设置滤镜模式
    ...
    public abstract void savePicture(SavePictureTask savePictureTask);//保存图片

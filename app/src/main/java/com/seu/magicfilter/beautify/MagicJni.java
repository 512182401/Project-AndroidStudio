...
public class MagicJni {
    ...
    public static native void jniInitMagicBeautify(ByteBuffer handler);//初始化
    ...
    public static native Bitmap jniGetBitmapFromStoredBitmapData(ByteBuffer handler);//滤镜保存图片
}
